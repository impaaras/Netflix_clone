...
const navbar = "https://assets.stickpng.com/images/580b57fcd9996e24bc43c529.png"
    ...
    return (
        ...
        <div className="nv_bar">
            <div className="navbar">
              <Link to="/"><img className="netflix" src = {navbar} alt="navbar"/></Link>
              <Link to="/login"><img  className="icon" src={image} alt={image}/></Link>
            </div>
        </div>
        <Switch>
        <Route path="/">
